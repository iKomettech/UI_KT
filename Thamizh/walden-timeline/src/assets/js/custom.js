...
$(document).ready(function () {
    ...
    $('#knob1,#knob2,#knob3,#knob4,#knob5').jqxKnob({
        value: 60,
        min: 0,
        max: 100,
        startAngle: 90,
    ...
    $(input1).jqxNumberInput(inputOptions);
    $(input2).jqxNumberInput(inputOptions);
    $(input3).jqxNumberInput(inputOptions);
    $(input4).jqxNumberInput(inputOptions);
    $(input5).jqxNumberInput(inputOptions);
