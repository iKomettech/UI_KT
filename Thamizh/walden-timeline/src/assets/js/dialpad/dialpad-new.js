    ...
    $(profileObject.bDials).each(function (key, val) {
        $('#knobbus' + val.dialId).jqxKnob({
            ...
            marks: {
                ...
                colorProgress: { color: '#9b3312', border: '#f44336' },
                type: 'line',
                offset: '80%',
                thickness: 1,
                size: '5%',
            ...
            spinner: {
                ...
                marks: {
                    colorRemaining: '#9b3312',
                    colorProgress: '#9b3312',
                    type: 'line',
                    offset: '72%',
                    thickness: 0,
                    size: '16%',
            ...
            progressBar: {
                style: { fill: { color: '#9b3312', gradientType: 'radial', gradientStops: [[1, 0.9], [100, 0.9]] } },
                size: '8%',
                offset: '70%',
                background: { fill: '#f44336', stroke: '#9b3312' }
            },
            pointer: {
                  type: 'circle', style: { fill: '#9b3312', stroke: '#f44336' }, size: '8%', offset: '72%', thickness: 1}
        });
