...
$(document).ready(function () {
    ...
    $('#pbi-form .eyeicon').click(function (e) {
        e.preventDefault();
        $(this).toggleClass('eyehide');
        var notVisible = $("#pbi-password").attr("type");
        if (notVisible === "password") {
        $("#pbi-password").attr("type", "text");
        }else {
        $("#pbi-password").attr("type", "password");
        }
    });

    $('#ebc-form .eyeicon').click(function (e) {
        e.preventDefault();
        $(this).toggleClass('eyehide');
        var notVisible = $("#ebc-password").attr("type");
        if (notVisible === "password") {
        $("#ebc-password").attr("type", "text");
        }else {
        $("#ebc-password").attr("type", "password");
        }
    });
...
$(document).ready(function(){
    ...
    $(".videopanel #loadmore").on("click", function(e){
        ...
        //$('.loader-div').show();
        setTimeout(function () {
            $(".colblock:hidden").slice(0, 4).slideDown(); 
            if($(".colblock").length == $('.colblock:visible').length){
                $('.viewallcta').hide();
            } 
        }, 1000);  
    });
...
$(document).ready(function(){
    if ($(".tabpanel .taColumnBlock .tabBoxBlock .contentblock").length > 0) {
        $(".tabBoxBlock .contentblock .contentsection a").hover(function () {
            $(this).closest(".contentblock").toggleClass('activecontent');
        });
        // var heights = $(".tabpanel .taColumnBlock .tabBoxBlock .contentblock .contentsection").map(function ()
        // {
        //     return $(this).height();
        // }).get();
        // maxHeight = Math.max.apply(null, heights);
        // $(".tabpanel .taColumnBlock .tabBoxBlock .contentblock .contentsection").css('height', maxHeight + 58);
...
$(document).ready(function(){
    ...
    var selectedValdesk = $(this).val();
    if (selectedValdesk == "Personal & Small Business") {
        $("#ebc-form").hide();
        $("#pbi-form").show();
        $('select#desk-account').val("Personal & Small Business").selectmenu('refresh');
    }
    else if (selectedValdesk == "Personal & Small Business") {
        $("#pbi-form").hide();
        $("#ebc-form").show();
        $('select#desk-account').val("Commercial").selectmenu('refresh');
    }else {
        $("#pbi-form").hide();
        $("#ebc-form").show();
        $('select#desk-account').val("Commercial").selectmenu('refresh');
