...
setTimeout(function () { $('.bannertwocolumnpanel ').addClass('come-in') }, 500);
$(document).ready(function () {
    (function ($) {
...
$('.dkhamburger').click(function (f) {
    ...
    function topPos() {
        ...
        if ($(window).outerWidth() >= 1024) {
            menutopPos = menuTop.top + 13;
        }
        if ($(window).outerWidth() >= 1030) {
            menutopPos = menuTop.top + 14;
        }
        if ($(window).outerWidth() >= 1070) {
            menutopPos = menuTop.top + 15;
        }
        if ($(window).outerWidth() >= 1090) {
            menutopPos = menuTop.top + 16;
        }
        if ($(window).outerWidth() >= 1140) {
            menutopPos = menuTop.top + 17;
        }
        if ($(window).outerWidth() >= 1160) {
            menutopPos = menuTop.top + 18;
        }
        if ($(window).outerWidth() >= 1180) {
            menutopPos = menuTop.top + 19;
        }
        if ($(window).outerWidth() >= 1200) {
            menutopPos = menuTop.top + 21;
        }
        if ($(window).outerWidth() >= 1230) {
            menutopPos = menuTop.top + 22;
        }
        if ($(window).outerWidth() >= 1250) {
            menutopPos = menuTop.top + 23;
        }
        if ($(window).outerWidth() >= 1270) {
            menutopPos = menuTop.top + 24;
        }
        if ($(window).outerWidth() >= 1280) {
            menutopPos = menuTop.top + 17;
        }
        ...
        if ($(window).outerWidth() >= 1360) {
            menutopPos = menuTop.top + 20;
        }
        if ($(window).outerWidth() >= 1400) {
            menutopPos = menuTop.top + 16;
        }
        if ($(window).outerWidth() >= 1425) {
            menutopPos = menuTop.top + 17;
        }
...
//scroll down banner 
$(document).ready(function () { // milliseconds

    $('.header-overlay').on('wheel', function (event) {

        if (event.originalEvent.deltaY > 0) {
            // Perform your action here
            console.log('Mouse scrolled down');
            // Example action: Smooth scroll to the next section
            $('html, body').animate({
                scrollTop: $('.header-overlay').scrollTop() + 300
            }, 500);
        }
    });
...
$(document).ready(function () {
    $(".banner-icon").click(function (event) {
        var topHeight = $(".bannertwocolumnpanel .rightWrap").outerHeight();
        $('html, body').animate({ scrollTop: + topHeight - 70 }, 800);
        return false;
    });
    ...
    $('.flexisearch i').on('click', function (e) {
        e.preventDefault();
        $('#searchInput').focus();
        $('.flexisearch').toggleClass('active');   
        $('.reserachLst').hide();
