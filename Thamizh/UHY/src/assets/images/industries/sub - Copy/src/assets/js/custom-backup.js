...
$(document).ready(function () {
    ...
    $('.alertHeader').css('top', $(".alertsection").height());
    if ($(window).width() > 1024) {
        $('.header-overlay').css('top', $(".alertsection").height() + 14);
     }
     else{
        $('.header-overlay').css('top', $(".alertsection").height() + 30);
     }
    var navTop = $('.alertHeader').height() + $(".alertsection").height();
    $('.nav-wrapper').css('top', navTop);
    $('.menu-wrap').css('top', $('.stickyEmpty').height() + 9);
    //console.log(navTop);
    $(window).on("resize", function (e) {
...
$(window).on("load resize", function () {
    ...
    if ($("header").hasClass("alertHeader")) {
        $('.alertHeader, .overlayAlert').css('top', $(".alertsection").height());
        $('.nav-wrapper').css('top', navTop);
    }
});
...
$(".alertsPannelClose").on("click", function () {
    ...
    $("header, .header-overlay").css('top', 0);
    $("header").removeClass('alertHeader');
    $(".header-overlay").addClass('overlayAlert');
    $(".nav-wrapper").css('top', '45px');
