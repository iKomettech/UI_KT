...
$(document).ready(function () {
    ...
    $('#inputSearch').keyup(function () {
        ...
        if (value != "" && value.length > 2) {
            ...
            setTimeout(function () {
                $('#midResults').show();
                $('#searchResultsHtmlAll, .bottomBtn').hide();
            }, 500);
        }
    });
...
function searchbox(){
    // var headertop = $('.header-submenu').height();
    // $('.searchBlock').css('top', headertop);
...
var emergencyAlertContent = window.localStorage.getItem('emergencyAlertContent');
var emergencyAlertContentHtml = $("#emergencyAlertContent").html();
if (emergencyAlertContentHtml != emergencyAlertContent)
    $(".alertsPannel").fadeIn();

var popupAlertContent = window.localStorage.getItem('popupAlertContent');
var popupAlertContentHtml = $(".popContent").html();
if (popupAlertContentHtml != popupAlertContent)
    $(".alertBox").fadeIn();
...
$("#popupAlertClose").on("click", function () {
    $(this).closest(".alertBox").fadeOut();
    window.localStorage.setItem('popupAlertContent', popupAlertContentHtml);
});
...
$(document).ready(function () {
    ...
    $('.menu-mega-blog .selectSpeciality').on('selectmenuchange', function() {
    ...
    $('.menu-mega-blog .selectCondition').on('selectmenuchange', function() {
        $('.mainMenu li.menu-mega-blog').addClass("menu-open"); 
        var selVal = this.value;
        if (selVal == selVal) {
            $('.mainMenu li.menu-mega-blog').addClass("menu-open"); 
...
$(document).ready(function () {
    ...
    $('.searchContent ul li .rsKeys').click(function() {
...
$(document).ready(function(){
    $('.obhblockpanels a[href*=\\#]:not([href=\\#])').on('click', function () {
        var target = $(this.hash);
...
$(document).ready(function(){
    $("#obhtvfeatures .obhvideolist").slice(0, 4).show();
        if ($("#obhtvfeatures .obhvideolist").length > 4) {
        $('#obhtvfeatures .btnwrap').show();
        $("#obhtvfeatures #loadMorevideo").on("click", function(e){
            e.preventDefault();
            ...
            $('#obhtvfeatures .btnwrap').hide();
            setTimeout(function () {
                $('#obhtvfeatures .btnwrap').show();
                $("#obhtvfeatures .obhvideolist:hidden").slice(0, 4).slideDown();
                if($("#obhtvfeatures .obhvideolist").length == $('#obhtvfeatures .obhvideolist:visible').length){
                    $('#obhtvfeatures .btnwrap').hide();
                } 
            }, 1000);  
        });
...
$(document).ready(function(){
    $("#obhinfomercials .obhvideolist").slice(0, 4).show();
    if ($("#obhinfomercials .obhvideolist").length > 4) {
        $('#obhinfomercials .btnwrap').show();
        $("#obhinfomercials #loadMoreinfo").on("click", function(e){
            e.preventDefault();
            var target = $(this).attr("href");
            //console.log(target.length);
            $('html, body').animate({
            ...
            $('#obhinfomercials .btnwrap').hide();
            setTimeout(function () {
                $('#obhinfomercials .btnwrap').show();
                $("#obhinfomercials .obhvideolist:hidden").slice(0, 4).slideDown();
                if($("#obhinfomercials .obhvideolist").length == $('#obhinfomercials .obhvideolist:visible').length){
                    $('#obhinfomercials .btnwrap').hide();
                } 
            }, 1000);  
        });
