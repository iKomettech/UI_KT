...
$(document).ready(function () {
    ...
    $(".select-language a").click(function () {
        $(".select-language .SubMenu").toggleClass("topsubmenu-view");
    });
    $("#selectmenu a, #selectmenu_mob a").click(function (e) {
        e.preventDefault();
        var lang = $(this).text();
    ...
    $(".selectSpeciality, .selectCondition").selectmenu()
    .selectmenu("menuWidget");
    $('.menu-open .selctbox').on('selectmenuchange', function() {
        $('.mainMenu li.menu-mega-blog').addClass("menu-open"); 
    });

    // var heights = $(".three_gridpanel .gridinfo .content_list").map(function ()
    // {
    //     return $(this).height();
    // }).get();
    ...
    //     $(".three_gridpanel .gridinfo .content_list").css('height',maxHeight+50);
    // }
