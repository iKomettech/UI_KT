    ...
    $.fn.extend({
        easyResponsiveTabs: function (options) {
            ...
            this.each(function () {
                ...
                var $tabItemh2;
                $respTabs.find('.resp-tab-content').before("<div class='resp-accordion' role='list'><span class='resp-arrow'></span></div>");
                ...
                $respTabs.find("[role=list]").each(function () {
                    var $currentTab = $(this);
