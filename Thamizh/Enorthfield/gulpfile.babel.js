...
gulp.task('build',
 gulp.series(clean, gulp.parallel(pages, javascript, images, copy), sass, styleGuide, heroslider, fourcolumnpanel,imageslicepanel,tabpanel,newsletter,findbranch,subbanner,newsdetails,getstarted,counter,alternative,twocolumnpanel,iconpanel,threecolumnpanel,generalcontent,ratetable,error,accordion,twocolumngridpanel,annualreport,locations,locationdetails,customer,sitemap,swiper));
...
//       }))
//       .pipe(gulp.dest('dist/assets/purgecss/'))
// });
let webpackConfig = {
