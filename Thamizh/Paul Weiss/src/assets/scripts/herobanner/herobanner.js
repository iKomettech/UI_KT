...
$(document).ready(function () {
    if ($('.homeBanner').length > 0) {
        ...
        function bannerimageht(){
            ...
            $('.bannertwocolumnpanel .flexwrap .leftWrap').css('margin-top', -imgHeight + 8);
            if ($(window).width() > 1800) {
                $('.bannertwocolumnpanel .flexwrap .rightWrap').css('margin-top', -contentPos.top - 161);
             }
                ...
                $('.bannertwocolumnpanel .flexwrap .leftWrap').css('margin-top', -imgHeight - 84);
